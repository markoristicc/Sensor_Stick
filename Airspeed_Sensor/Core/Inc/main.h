...
#define INT_SS_Pin GPIO_PIN_0
#define INT_SS_GPIO_Port GPIOA
...
#define DSPSCL_Pin GPIO_PIN_13
#define DSPSCL_GPIO_Port GPIOB
#define DSPSCA_Pin GPIO_PIN_14
#define DSPSCA_GPIO_Port GPIOB
