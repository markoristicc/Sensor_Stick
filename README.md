...
The files containing the dragonfly PCB driver code can be found in the SensorStick_integrated folder. This code was developed using the STM32CubeIDE, so that may be most convenient for you, however any embedded C development environment should suffice for flashing the PCB.  
