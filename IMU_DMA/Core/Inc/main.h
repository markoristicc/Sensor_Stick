...
#define ACCEL_DRDY_Pin GPIO_PIN_0
#define ACCEL_DRDY_GPIO_Port GPIOA
#define ACCEL_DRDY_EXTI_IRQn EXTI0_IRQn
#define USART_TX_Pin GPIO_PIN_2
#define USART_TX_GPIO_Port GPIOA
#define USART_RX_Pin GPIO_PIN_3
#define USART_RX_GPIO_Port GPIOA
#define GYRO_DRDY_Pin GPIO_PIN_2
#define GYRO_DRDY_GPIO_Port GPIOB
#define GYRO_DRDY_EXTI_IRQn EXTI2_IRQn
