...
*/
  while (1)
  {
	  ...
	  //READ GYRO MEASUREMENTS
	    ...
	    HAL_Delay(1000);
	    /*char buff2[127];
	    snprintf(buff2, 127, "Gyro X = %f\r\n Gyro Y = %f\r\n Gyro Z = %f\r\n", Gx, Gy, Gz);
	    CDC_Transmit_FS((uint8_t *)buff2, strlen(buff2));
	    HAL_Delay(1000);
	    HAL_Delay(1000);*/
	    /*char buff2[127];
	    snprintf(buff2, 127, "Accel Y = %f\r\n", Ay);
	    CDC_Transmit_FS((uint8_t *)buff2, strlen(buff2));
	    char buff3[127];
	    snprintf(buff3, 127, "Accel Z = %f\r\n", Az);
	    CDC_Transmit_FS((uint8_t *)buff3, strlen(buff3));
	    char buff4[127];
	    snprintf(buff4, 127, "Gyro X = %f\r\n", Gx);
	    CDC_Transmit_FS((uint8_t *)buff4, strlen(buff4));
	    char buff5[127];
	    snprintf(buff5, 127, "Gyro Y = %f\r\n", Gy);
	    CDC_Transmit_FS((uint8_t *)buff5, strlen(buff5));
	    char buff6[127];
	    snprintf(buff6, 127, "Gyro Z = %f\r\n", Gz);
	    CDC_Transmit_FS((uint8_t *)buff6, strlen(buff6));*/
  }
}
