...
/* Private defines -----------------------------------------------------------*/
#define BMI085_Accel_DR_INT_Pin GPIO_PIN_4
#define BMI085_Accel_DR_INT_GPIO_Port GPIOC
#define BMI085_Accel_DR_INT_EXTI_IRQn EXTI4_IRQn
...
#define BMI085a_NSS_Pin GPIO_PIN_8
#define BMI085a_NSS_GPIO_Port GPIOB
